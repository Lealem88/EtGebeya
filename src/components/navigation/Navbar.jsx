            ...
            {isAuthenticated ? (
              <>
                ...
                <div ref={userMenuRef} className="relative">
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-surface-800 rounded-xl shadow-xl border border-surface-200 dark:border-surface-700 py-2 animate-scale-in origin-top-right">
